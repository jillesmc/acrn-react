...
class App extends Component {
  constructor(props, context) {
    ...
    let localVolume = this.getLocalStorageInt(
      constants.VOLUME_KEY,
      constants.DEFAULT_VOLUME
    );
    let localFreq = this.getLocalStorageInt(
      constants.FREQ_KEY,
      constants.DEFAULT_FREQ
    );
    let playerState = this.getLocalStorageInt(
      constants.PLAYER_STATE_KEY,
      constants.PLAYER_STATES.PLAY_TONE
    );
    ...
    if (isPlaying) {
      switch (playState) {
        case constants.PLAYER_STATES.PLAY_ACRN:
          this.setState({
            playButtonText: constants.STOP_SEQ_TEXT,
            enableSlider: false,
          });
      ...
      <div className="App">
        <div className="container ">
          ...
          <p>
            ...
            <a
              href="https://www.thetinnitusclinic.co.uk/tinnitus-treatment/acoustic-neuromodulation/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Acoustic Coordinated Reset Neuromodulation
            </a>{" "}
            tinnitus treatment protocol using{" "}
            <a
              href="https://www.tinnitustalk.com/attachments/tass-et-al_rnn-2012_counteracting-tinnitus-by-acoustic-cr-neuromodulation-pdf.183/"
              target="_blank"
              rel="noopener noreferrer"
            >
              this paper
          ...
          <div className="instructions">
            <ul>
              <li>
                First lower the volume on your device, so it is not too loud to
                start.
              </li>
              <li>Start the tone by pressing the "Play Tone" button.</li>
              <li>
                Adjust the frequency slider until it matches your tinnitus tone.
                You can also type in the frequency if you know it already.
              </li>
              <li>
                Adjust the volume until it is a little bit louder than your
                tinnitus tone.
              </li>
          ...
          <p>
            Inspired by{" "}
            <a
              href="http://www.tinnitustalk.com/threads/acoustic-cr%C2%AE-neuromodulation-do-it-yourself-guide.1469/"
              target="_blank"
              rel="noopener noreferrer"
            >
              this
            ...
            thread on{" "}
            <a
              href="http://www.tinnitustalk.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              tinnitustalk.com
            ...
            and{" "}
            <a
              href="http://www.reddit.com/r/tinnitus/comments/15x99f/recent_tinnitus_study_and_my_attempt_at_utilizing/"
              target="_blank"
              rel="noopener noreferrer"
            >
              this
          ...
          <p>
            Developed by{" "}
            <a
              href="https://github.com/headphonejames/acrn-react"
              target="_blank"
              rel="noopener noreferrer"
            >
              Headphones James
            </a>{" "}
            and Packaged into Electron by{" "}
            <a
              href="https://github.com/jillesmc"
              target="_blank"
              rel="noopener noreferrer"
            >
              Jilles Cardoso
          ...
          <div>
            ...
            >
              <ToggleButton value={constants.PLAYER_STATES.PLAY_TONE}>
                Tone
              </ToggleButton>
              <ToggleButton value={constants.PLAYER_STATES.PLAY_ACRN}>
                Sequence
              </ToggleButton>
            </ToggleButtonGroup>
            <br />
            ...
            <div>
              <input
                ...
                onChange={this.handleTextFreqChange}
                value={freq}
              />
            </div>
            {playState === constants.PLAYER_STATES.PLAY_ACRN && (
              <div>
                <br />
                <i>
                  frequencies used in sequence:{" "}
                  {this.generateFreqs(freq).map(
